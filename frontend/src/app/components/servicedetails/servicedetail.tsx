  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] font-sans text-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            ...
            {service.includes?.map(
              (item, index) => (
                <div
                  key={index}
                  className="bg-[#151515] rounded-2xl p-6 border border-white/[0.07]"
                >
        ...
        <div className="mt-20 bg-[#111111] rounded-[24px] px-8 py-10 md:px-12 md:py-14 flex flex-col md:flex-row md:items-center md:justify-between gap-8 border border-white/10">
